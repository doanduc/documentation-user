...
disable the tests allow specific test to b erun with custom tags in the :ref:`branch's settings <odoosh-gettingstarted-branches-tabs-settings>`.
...
When the test suite is enabled, you can restrict the tests to bu run for specific tests by adding test tags.
`test tags <https://www.odoo.com/documentation/12.0/reference/testing.html#test-selection>`_.
